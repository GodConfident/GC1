...
<body style="padding: 10px;background: #fff;">
  <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    ...
    @endif
  <form class="layui-form layui-form-pane" action="/admin/news/{{$fill['id']}}" method="post">


<div class="layui-form-item" style="width:700px">
  <label class="layui-form-label">新闻标题</label>
  <div class="layui-input-block">
    <input type="text" name="title" lay-verify="title" autocomplete="off" class="layui-input" value="{{$fill['title']}}">
  </div>
</div>

<!-- 加载百度编辑器的容器 -->
    <script id="container" name="content" type="text/plain">{!!$fill['content']!!}</script>
    <!-- 配置文件 -->
...
<input type="hidden" name="img" value="{{$fill['img']}}">
<input type="hidden" name="_method" value="PUT">
{{csrf_field()}}
<div class="layui-form-item">
  <div class="layui-input-block">
    <button class="layui-btn" lay-submit="" onclick="newsimg()" lay-filter="demo1">提交修改</button>
